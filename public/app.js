...
function displayResults(newsData) {
  ...
  for (var i = 0; i < newsData.length; i++) {
    ...
    $("#homePage").append("<textarea id='bodyinput' name='body'></textarea>"),

    $("#homePage").append("<button data-id='" + newsData[i]._id + "' id='comment'>Submit Comment</button>")
    $("#homePage").append("<button data-id='" + i + "' id='save'>Save Article</button><hr>")
